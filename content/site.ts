export const site = {
  ...
  linkedin: 'https://www.linkedin.com/in/viberaihan/',
  linkedinHandle: 'viberaihan',
  ...
  services: [
    ...
    },
    {
      key: 'ai',
      title: 'AI Automation',
      tag: 'n8n · Agents · Integrations',
      blurb:
        'Custom n8n workflows, autonomous agents, and API integrations that replace manual ops. We wire your stack so your team can stop copy-pasting and start compounding.',
      deliverables: [
        'n8n workflow builds',
        'Autonomous AI agents',
        'CRM & SaaS integrations',
        'Data pipelines & sync jobs',
      ],
    },
  ],
  tools: [
